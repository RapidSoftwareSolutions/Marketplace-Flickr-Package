...
$app->post('/api/Flickr/checkUploadTickets', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessSecret','tickets']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','accessToken'=>'oauth_token','accessSecret'=>'oauth_secret','tickets'=>'tickets'];
    $optionalParams = [];
    $bodyParams = [
       'query' => ['tickets','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];

    $data = \Models\Params::createParams($requiredParams, $optionalParams, $post_data['args']);

    
    $data['tickets'] = \Models\Params::toString($data['tickets'], ','); 
    ...
    $data['method'] = 'flickr.photos.upload.checkTickets';
