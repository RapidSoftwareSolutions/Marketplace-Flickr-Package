...
$app->post('/api/Flickr/getUserPhotosets', function ($request, $response) {
    ...
    $optionalParams = ['userId'=>'user_id','page'=>'page','perPage'=>'per_page','photoIds'=>'photo_ids','primaryPhotoExtras'=>'primary_photo_extras'];
    $bodyParams = [
       'query' => ['primary_photo_extras','photo_ids','per_page','page','user_id','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];

    $data = \Models\Params::createParams($requiredParams, $optionalParams, $post_data['args']);

    
    if(isset($data['photo_ids'])) { $data['photo_ids'] = \Models\Params::toString($data['photo_ids'], ','); }
    if(isset($data['primary_photo_extras'])) { $data['primary_photo_extras'] = \Models\Params::toString($data['primary_photo_extras'], ','); }
    ...
    $data['method'] = 'flickr.photosets.getList';
