...
$app->post('/api/Flickr/getSuggenstionsList', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessSecret','statusId','photoId']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','accessToken'=>'oauth_token','accessSecret'=>'oauth_secret','statusId'=>'status_id','photoId'=>'photo_id'];
    $optionalParams = [];
    $bodyParams = [
       'query' => ['photo_id','status_id','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.photos.suggestions.getList';
