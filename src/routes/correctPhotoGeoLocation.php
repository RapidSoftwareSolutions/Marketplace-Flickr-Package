...
$app->post('/api/Flickr/correctPhotoGeoLocation', function ($request, $response) {
    ...
    $optionalParams = ['placeId'=>'place_id','woeId'=>'woe_id','foursquareId'=>'foursquare_id'];
    $bodyParams = [
       'query' => ['oauth_token','oauth_secret','api_secret','api_key','method','format','nojsoncallback','foursquare_id','place_id','woe_id','photo_id']
    ];
    ...
    $data['method'] = 'flickr.photos.geo.correctLocation';
$data['format'] = 'json';
