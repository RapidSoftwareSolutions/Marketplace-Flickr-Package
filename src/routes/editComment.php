...
$app->post('/api/Flickr/editComment', function ($request, $response) {
    ...
    $optionalParams = [];
    $bodyParams = [
       'query' => ['comment_id','comment_text','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.photosets.comments.editComment';
