...
$app->post('/api/Flickr/getContactsList', function ($request, $response) {
    ...
    $optionalParams = ['filter'=>'filter','perPage'=>'per_page','page'=>'page','sort'=>'sort'];
    $bodyParams = [
       'query' => ['oauth_token','oauth_secret','api_secret','api_key','method','filter','format','page','per_page','sort','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.contacts.getList';
$data['format'] = 'json';
