...
$app->post('/api/Flickr/getGalleryListForPhoto', function ($request, $response) {
    ...
    $bodyParams = [
       'query' => ['api_key','method','format','photo_id','per_page','page','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.galleries.getListForPhoto';
$data['format'] = 'json';
