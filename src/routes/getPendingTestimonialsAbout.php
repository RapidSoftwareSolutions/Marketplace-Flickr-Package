...
$app->post('/api/Flickr/getPendingTestimonialsAbout', function ($request, $response) {
    ...
    $bodyParams = [
       'query' => ['per_page','page','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.testimonials.getPendingTestimonialsAbout';
