...
$app->post('/api/Flickr/getHotList', function ($request, $response) {
    ...
    $optionalParams = ['period'=>'period','count'=>'count'];
    $bodyParams = [
       'query' => ['count','period','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.tags.getHotList';
