...
$app->post('/api/Flickr/getMostFrequentlyUsed', function ($request, $response) {
    ...
    $optionalParams = [];
    $bodyParams = [
       'query' => ['method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.tags.getMostFrequentlyUsed';
