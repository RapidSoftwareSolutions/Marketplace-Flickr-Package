...
$app->post('/api/Flickr/joinGroup', function ($request, $response) {
    ...
    $optionalParams = ['acceptRules'=>'accept_rules'];
    $bodyParams = [
       'query' => ['oauth_token','oauth_secret','api_secret','api_key','method','group_id','format','accept_rules','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.groups.join';
$data['format'] = 'json';
