...
$app->post('/api/Flickr/getUploadStatus', function ($request, $response) {
    ...
    $optionalParams = [];
    $bodyParams = [
       'query' => ['oauth_token','oauth_secret','api_secret','api_key','method','format','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.people.getUploadStatus';
$data['format'] = 'json';
