...
$app->post('/api/Flickr/orderSets', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessSecret','photosetIds']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','accessToken'=>'oauth_token','accessSecret'=>'oauth_secret','photosetIds'=>'photoset_ids'];
    $optionalParams = [];
    $bodyParams = [
       'query' => ['photoset_ids','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];

    $data = \Models\Params::createParams($requiredParams, $optionalParams, $post_data['args']);

    
    $data['photoset_ids'] = \Models\Params::toString($data['photoset_ids'], ','); 
    ...
    $data['method'] = 'flickr.photosets.orderSets';
