...
$app->post('/api/Flickr/getPhotostreamReferrers', function ($request, $response) {
    ...
    $bodyParams = [
       'query' => ['domain','page','per_page','date','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.stats.getPhotostreamReferrers';
