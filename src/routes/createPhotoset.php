...
$app->post('/api/Flickr/createPhotoset', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessSecret','title','primaryPhotoId']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','accessToken'=>'oauth_token','accessSecret'=>'oauth_secret','title'=>'title','primaryPhotoId'=>'primary_photo_id'];
    $optionalParams = ['description'=>'description'];
    $bodyParams = [
       'query' => ['description','primary_photo_id','title','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
