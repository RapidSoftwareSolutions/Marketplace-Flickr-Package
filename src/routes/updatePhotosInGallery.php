...
$app->post('/api/Flickr/updatePhotosInGallery', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessSecret','primaryPhotoId','photoIds','galleryId']);
    ...
    $data['method'] = 'flickr.galleries.editPhotos';
$data['format'] = 'json';
