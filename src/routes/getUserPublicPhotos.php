...
$app->post('/api/Flickr/getUserPublicPhotos', function ($request, $response) {
    ...
    $optionalParams = ['safeSearch'=>'safe_search','extras'=>'extras','perPage'=>'per_page','page'=>'page'];
    $bodyParams = [
       'query' => ['api_key','method','format','nojsoncallback','safe_search','user_id','extras','page','per_page']
    ];
