...
$app->post('/api/Flickr/leaveGroup', function ($request, $response) {
    ...
    $optionalParams = ['deletePhotos'=>'delete_photos'];
    $bodyParams = [
       'query' => ['oauth_token','oauth_secret','api_secret','api_key','method','group_id','delete_photos','format','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.groups.leave';
$data['format'] = 'json';
