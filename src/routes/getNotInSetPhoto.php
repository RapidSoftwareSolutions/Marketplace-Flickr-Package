...
$app->post('/api/Flickr/getNotInSetPhoto', function ($request, $response) {
    ...
    $optionalParams = ['maxUploadDate'=>'max_upload_date','minTakenDate'=>'min_taken_date','maxTakenDate'=>'max_taken_date','privacyFilter'=>'privacy_filter','media'=>'media','min_upload_date'=>'min_upload_date','extras'=>'extras','perPage'=>'per_page','page'=>'page'];
    $bodyParams = [
       'query' => ['oauth_token','oauth_secret','api_secret','api_key','method','format','nojsoncallback','max_upload_date','min_taken_date','max_taken_date','privacy_filter','media','min_upload_date','extras','per_page','page']
    ];
    ...
    $data['method'] = 'flickr.photos.getNotInSet';
$data['format'] = 'json';
