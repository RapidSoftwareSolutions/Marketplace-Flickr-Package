...
$app->post('/api/Flickr/getListDiscussionTopicsInGroup', function ($request, $response) {
    ...
    $bodyParams = [
       'query' => ['api_key','method','group_id','page','per_page','format','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.groups.discuss.topics.getList';
$data['format'] = 'json';
