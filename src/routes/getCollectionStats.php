...
$app->post('/api/Flickr/getCollectionStats', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessSecret','date','collectionId']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','accessToken'=>'oauth_token','accessSecret'=>'oauth_secret','date'=>'date','collectionId'=>'collection_id'];
    $optionalParams = [];
    $bodyParams = [
       'query' => ['collection_id','date','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.stats.getCollectionStats';
