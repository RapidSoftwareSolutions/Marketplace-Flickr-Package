...
$app->post('/api/Flickr/getChildrenWithPhotosPublicByPlaceId', function ($request, $response) {
    ...
    $optionalParams = [];
    $bodyParams = [
       'query' => ['place_id','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.places.getChildrenWithPhotosPublic';
