...
$app->post('/api/Flickr/getFavoritePhotosList', function ($request, $response) {
    ...
    $bodyParams = [
       'query' => ['api_key','method','format','photo_id','min_fave_date','max_fave_date','extras','per_page','page','user_id','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.favorites.getList';
$data['format'] = 'json';
