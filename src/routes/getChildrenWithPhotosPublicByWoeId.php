...
$app->post('/api/Flickr/getChildrenWithPhotosPublicByWoeId', function ($request, $response) {
    ...
    $optionalParams = [];
    $bodyParams = [
       'query' => ['woe_id','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
