...
$app->post('/api/Flickr/getUserPhotosInPhotoset', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessSecret','userId','photosetId']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','accessToken'=>'oauth_token','accessSecret'=>'oauth_secret','userId'=>'user_id','photosetId'=>'photoset_id'];
    $optionalParams = ['page'=>'page','perPage'=>'per_page','extras'=>'extras','privacyFilter'=>'privacy_filter','media'=>'media'];
    $bodyParams = [
       'query' => ['media','privacy_filter','extras','per_page','page','photoset_id','user_id','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
