...
$app->post('/api/Flickr/getBlogList', function ($request, $response) {
    ...
    $optionalParams = ['service'=>'service'];
    $bodyParams = [
       'query' => ['oauth_token','oauth_secret','api_secret','api_key','service','method','format','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.blogs.getList';
$data['format'] = 'json';
