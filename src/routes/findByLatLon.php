...
$app->post('/api/Flickr/findByLatLon', function ($request, $response) {
    ...
    $optionalParams = ['accuracy'=>'accuracy'];
    $bodyParams = [
       'query' => ['accuracy','lon','lat','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.places.findByLatLon';
