...
$app->post('/api/Flickr/getUserPhotos', function ($request, $response) {
    ...
    $optionalParams = ['perPage'=>'per_page','page'=>'page','timeframe'=>'timeframe'];
    $bodyParams = [
       'query' => ['method','oauth_token','oauth_secret','api_secret','api_key','per_page','format','page','timeframe','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.activity.userPhotos';
$data['format'] = 'json';
