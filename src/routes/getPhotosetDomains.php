...
$app->post('/api/Flickr/getPhotosetDomains', function ($request, $response) {
    ...
    $bodyParams = [
       'query' => ['page','per_page','photoset_id','date','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.stats.getPhotosetDomains';
