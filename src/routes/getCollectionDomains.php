...
$app->post('/api/Flickr/getCollectionDomains', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessSecret','date']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','accessToken'=>'oauth_token','accessSecret'=>'oauth_secret','date'=>'date'];
    $optionalParams = ['collectionId'=>'collection_id','page'=>'page','perPage'=>'per_page'];
    $bodyParams = [
       'query' => ['page','per_page','collection_id','date','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.stats.getCollectionDomains';
