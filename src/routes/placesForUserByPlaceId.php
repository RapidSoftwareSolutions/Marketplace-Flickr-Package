...
$app->post('/api/Flickr/placesForUserByPlaceId', function ($request, $response) {
    ...
    $bodyParams = [
       'query' => ['max_taken_date','min_taken_date','max_upload_date','min_upload_date','threshold','place_type','place_type_id','place_id','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
