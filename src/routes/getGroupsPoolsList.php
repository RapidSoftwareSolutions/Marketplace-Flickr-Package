...
$app->post('/api/Flickr/getGroupsPoolsList', function ($request, $response) {
    ...
    $bodyParams = [
       'query' => ['api_secret','oauth_token','oauth_secret','api_key','method','page','per_page','format','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.groups.pools.getGroups';
$data['format'] = 'json';
