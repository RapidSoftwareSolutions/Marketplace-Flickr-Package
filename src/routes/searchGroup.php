...
$app->post('/api/Flickr/searchGroup', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessSecret','text']);
    ...
    $data['method'] = 'flickr.groups.search';
$data['format'] = 'json';
