...
$app->post('/api/Flickr/editPhotosetMeta', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessSecret','photosetId','title']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','accessToken'=>'oauth_token','accessSecret'=>'oauth_secret','photosetId'=>'photoset_id','title'=>'title'];
    $optionalParams = ['description'=>'description'];
    $bodyParams = [
       'query' => ['description','title','photoset_id','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.photosets.editMeta';
