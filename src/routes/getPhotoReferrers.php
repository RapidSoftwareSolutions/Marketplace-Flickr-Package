...
$app->post('/api/Flickr/getPhotoReferrers', function ($request, $response) {
    ...
    $optionalParams = ['photoId'=>'photo_id','page'=>'page','perPage'=>'per_page'];
    $bodyParams = [
       'query' => ['domain','page','per_page','photo_id','date','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.stats.getPhotoReferrers';
