...
$app->post('/api/Flickr/deletePersonCoordinatesFromPhoto', function ($request, $response) {
    ...
    $optionalParams = [];
    $bodyParams = [
       'query' => ['photo_id','user_id','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.photos.people.deleteCoords';
