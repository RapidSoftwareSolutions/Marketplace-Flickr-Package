...
$app->post('/api/Flickr/setPhotoDates', function ($request, $response) {
    ...
    $optionalParams = ['datePosted'=>'date_posted','dateTaken'=>'date_taken','dateTakenGranularity'=>'date_taken_granularity'];
    $bodyParams = [
       'query' => ['oauth_token','oauth_secret','api_secret','api_key','method','format','nojsoncallback','date_taken_granularity','photo_id','date_taken','date_posted']
    ];
