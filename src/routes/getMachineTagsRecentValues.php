...
$app->post('/api/Flickr/getMachineTagsRecentValues', function ($request, $response) {
    ...
    $optionalParams = ['addedSince'=>'added_since','namespace'=>'namespace','predicate'=>'predicate'];
    $bodyParams = [
       'query' => ['api_key','method','namespace','added_since','format','predicate','nojsoncallback']
    ];
