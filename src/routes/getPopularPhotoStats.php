...
$app->post('/api/Flickr/getPopularPhotoStats', function ($request, $response) {
    ...
    $optionalParams = ['date'=>'date','sort'=>'sort','page'=>'page','perPage'=>'per_page'];
    $bodyParams = [
       'query' => ['sort','page','per_page','date','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];

    $data = \Models\Params::createParams($requiredParams, $optionalParams, $post_data['args']);

    
    if(isset($data['date'])) { $data['date'] = \Models\Params::toFormat($data['date'], 'Y-m-d'); }
    ...
    $data['method'] = 'flickr.stats.getPopularPhotos';
