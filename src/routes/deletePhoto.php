...
$app->post('/api/Flickr/deletePhoto', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','photoId','accessSecret']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','accessToken'=>'oauth_token','photoId'=>'photo_id','accessSecret'=>'oauth_secret'];
    $optionalParams = [];
    $bodyParams = [
