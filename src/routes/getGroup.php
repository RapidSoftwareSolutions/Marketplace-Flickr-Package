...
$app->post('/api/Flickr/getGroup', function ($request, $response) {
    ...
    $optionalParams = [];
    $bodyParams = [
       'query' => ['method','group_id','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.urls.getGroup';
