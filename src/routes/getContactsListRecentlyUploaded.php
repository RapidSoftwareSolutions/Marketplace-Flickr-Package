...
$app->post('/api/Flickr/getContactsListRecentlyUploaded', function ($request, $response) {
    ...
    $optionalParams = ['filter'=>'filter','dateLastupload'=>'date_lastupload'];
    $bodyParams = [
       'query' => ['oauth_token','oauth_secret','api_secret','api_key','method','format','filter','dateLastupload','nojsoncallback']
    ];

    $data = \Models\Params::createParams($requiredParams, $optionalParams, $post_data['args']);

    
    if(isset($data['date_lastupload'])) { $data['date_lastupload'] = \Models\Params::toFormat($data['date_lastupload'], 'unixtime'); }
    ...
    $data['method'] = 'flickr.contacts.getListRecentlyUploaded';
$data['format'] = 'json';
