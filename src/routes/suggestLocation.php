...
$app->post('/api/Flickr/suggestLocation', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessSecret','photoId','coordinates']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','accessToken'=>'oauth_token','accessSecret'=>'oauth_secret','photoId'=>'photo_id','coordinates'=>'coordinates'];
    $optionalParams = ['accuracy'=>'accuracy','woeId'=>'woe_id','placeId'=>'place_id','note'=>'note'];
    $bodyParams = [
       'query' => ['note','place_id','woe_id','accuracy','lat','lon','photo_id','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
