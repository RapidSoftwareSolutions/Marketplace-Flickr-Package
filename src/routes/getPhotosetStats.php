...
$app->post('/api/Flickr/getPhotosetStats', function ($request, $response) {
    ...
    $optionalParams = ['photosetId'=>'photoset_id'];
    $bodyParams = [
       'query' => ['photoset_id','date','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.stats.getPhotosetStats';
