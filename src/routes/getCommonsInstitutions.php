...
$app->post('/api/Flickr/getCommonsInstitutions', function ($request, $response) {
    ...
    $optionalParams = [];
    $bodyParams = [
       'query' => ['api_key','method','format','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.commons.getInstitutions';
$data['format'] = 'json';
