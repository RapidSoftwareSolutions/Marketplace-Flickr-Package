...
$app->post('/api/Flickr/getUserComments', function ($request, $response) {
    ...
    $bodyParams = [
       'query' => ['oauth_token','oauth_secret','api_secret','format','method','api_key','per_page','page','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.activity.userComments';
    $data['format'] = 'json';
