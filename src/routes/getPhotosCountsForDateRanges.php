...
$app->post('/api/Flickr/getPhotosCountsForDateRanges', function ($request, $response) {
    ...
    $optionalParams = ['dates'=>'dates'];
    $bodyParams = [
       'query' => ['oauth_token','oauth_secret','api_secret','api_key','method','format','nojsoncallback','dates']
    ];
    ...
    $data['method'] = 'flickr.photos.getCounts';
$data['format'] = 'json';
