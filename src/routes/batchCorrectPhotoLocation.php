...
$app->post('/api/Flickr/batchCorrectPhotoLocation', function ($request, $response) {
    ...
    $optionalParams = ['placeId'=>'place_id','woeId'=>'woe_id'];
    $bodyParams = [
       'query' => ['oauth_token','oauth_secret','api_secret','api_key','method','format','nojsoncallback','lat','lon','accuracy','place_id','woe_id']
    ];
