...
$app->post('/api/Flickr/setSafetyLevelOfPhoto', function ($request, $response) {
    ...
    $optionalParams = ['safetyLevel'=>'safety_level','hidden'=>'hidden'];
    $bodyParams = [
       'query' => ['oauth_token','oauth_secret','api_secret','api_key','method','format','nojsoncallback','photo_id','safety_level','hidden']
    ];
    ...
    $data['method'] = 'flickr.photos.setSafetyLevel';
$data['format'] = 'json';
