...
$app->post('/api/Flickr/removePhotoFromFavoritesList', function ($request, $response) {
    ...
    $optionalParams = [];
    $bodyParams = [
       'query' => ['oauth_token','oauth_secret','api_secret','format','api_key','method','photo_id','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.favorites.remove';
$data['format'] = 'json';
