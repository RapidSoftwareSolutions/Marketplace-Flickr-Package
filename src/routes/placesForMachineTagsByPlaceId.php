...
$app->post('/api/Flickr/placesForMachineTagsByPlaceId', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessSecret','placeId','machineTags']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','accessToken'=>'oauth_token','accessSecret'=>'oauth_secret','placeId'=>'place_id','machineTags'=>'machine_tags'];
    $optionalParams = ['placeTypeId'=>'place_type_id','threshold'=>'threshold','machineTagMode'=>'machine_tag_mode','minUploadDate'=>'min_upload_date','maxUploadDate'=>'max_upload_date','minTakenDate'=>'min_taken_date','maxTakenDate'=>'max_taken_date'];
    $bodyParams = [
       'query' => ['machine_tags','max_taken_date','min_taken_date','max_upload_date','min_upload_date','machine_tag_mode','threshold','place_type_id','place_id','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];

    $data = \Models\Params::createParams($requiredParams, $optionalParams, $post_data['args']);

    
    $data['machine_tags'] = \Models\Params::toString($data['machine_tags'], ','); 
    ...
    $data['method'] = 'flickr.places.placesForTags';
