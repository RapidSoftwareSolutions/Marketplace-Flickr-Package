...
$app->post('/api/Flickr/getPhotosetReferrers', function ($request, $response) {
    ...
    $optionalParams = ['photosetId'=>'photoset_id','page'=>'page','perPage'=>'per_page'];
    $bodyParams = [
       'query' => ['domain','page','per_page','photoset_id','date','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.stats.getPhotosetReferrers';
