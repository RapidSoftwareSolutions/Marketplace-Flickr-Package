...
$app->post('/api/Flickr/addPhotoToFavoritesList', function ($request, $response) {
    ...
    $optionalParams = [];
    $bodyParams = [
       'query' => ['oauth_token','oauth_secret','api_secret','api_key','method','photo_id','format','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.favorites.add';
$data['format'] = 'json';
