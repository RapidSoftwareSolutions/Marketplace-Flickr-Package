...
$app->post('/api/Flickr/editPhotosetPhotos', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessSecret','photosetId','primaryPhotoId','photoIds']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','accessToken'=>'oauth_token','accessSecret'=>'oauth_secret','photosetId'=>'photoset_id','primaryPhotoId'=>'primary_photo_id','photoIds'=>'photo_ids'];
    $optionalParams = [];
    $bodyParams = [
       'query' => ['photo_ids','primary_photo_id','photoset_id','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.photosets.editPhotos';
