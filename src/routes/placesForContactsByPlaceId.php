...
$app->post('/api/Flickr/placesForContactsByPlaceId', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessSecret','placeId']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','accessToken'=>'oauth_token','accessSecret'=>'oauth_secret','placeId'=>'place_id'];
    $optionalParams = ['placeTypeId'=>'place_type_id','placeType'=>'place_type','threshold'=>'threshold','contacts'=>'contacts','minUploadDate'=>'min_upload_date','maxUploadDate'=>'max_upload_date','minTakenDate'=>'min_taken_date','maxTakenDate'=>'max_taken_date'];
    $bodyParams = [
       'query' => ['max_taken_date','min_taken_date','max_upload_date','min_upload_date','contacts','threshold','place_type','place_type_id','place_id','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.places.placesForContacts';
