...
$app->post('/api/Flickr/getPeopleByFavoritePhotoId', function ($request, $response) {
    ...
    $bodyParams = [
       'query' => ['api_key','method','format','nojsoncallback','photo_id','per_page','page']
    ];
    ...
    $data['method'] = 'flickr.photos.getFavorites';
$data['format'] = 'json';
