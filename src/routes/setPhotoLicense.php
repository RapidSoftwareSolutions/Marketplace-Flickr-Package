...
$app->post('/api/Flickr/setPhotoLicense', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessSecret','photoId','licenseId']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','accessToken'=>'oauth_token','accessSecret'=>'oauth_secret','photoId'=>'photo_id','licenseId'=>'license_id'];
    $optionalParams = [];
    $bodyParams = [
       'query' => ['license_id','photo_id','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.photos.licenses.setLicense';
