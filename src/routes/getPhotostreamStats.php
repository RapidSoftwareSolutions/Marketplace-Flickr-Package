...
$app->post('/api/Flickr/getPhotostreamStats', function ($request, $response) {
    ...
    $optionalParams = [];
    $bodyParams = [
       'query' => ['date','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.stats.getPhotostreamStats';
