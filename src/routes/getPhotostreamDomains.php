...
$app->post('/api/Flickr/getPhotostreamDomains', function ($request, $response) {
    ...
    $bodyParams = [
       'query' => ['page','per_page','date','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.stats.getPhotostreamDomains';
