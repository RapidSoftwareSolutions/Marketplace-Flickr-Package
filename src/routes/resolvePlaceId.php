...
$app->post('/api/Flickr/resolvePlaceId', function ($request, $response) {
    ...
    $optionalParams = [];
    $bodyParams = [
       'query' => ['method','place_id','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.places.resolvePlaceId';
