...
$app->post('/api/Flickr/getContactsTaggingSuggestions', function ($request, $response) {
    ...
    $optionalParams = ['filter'=>'filter','perPage'=>'per_page','page'=>'page'];
    $bodyParams = [
       'query' => ['oauth_token','oauth_secret','api_secret','api_key','method','page','format','per_page','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.contacts.getTaggingSuggestions';
$data['format'] = 'json';
