...
$app->post('/api/Flickr/placesForContactsByWoeId', function ($request, $response) {
    ...
    $bodyParams = [
       'query' => ['max_taken_date','min_taken_date','max_upload_date','min_upload_date','contacts','threshold','place_type','place_type_id','woe_id','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
