...
$app->post('/api/Flickr/getPhotoDomains', function ($request, $response) {
    ...
    $bodyParams = [
       'query' => ['page','per_page','photo_id','date','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.stats.getPhotoDomains';
