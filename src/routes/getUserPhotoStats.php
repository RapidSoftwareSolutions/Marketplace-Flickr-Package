...
$app->post('/api/Flickr/getUserPhotoStats', function ($request, $response) {
    ...
    $optionalParams = ['photoId'=>'photo_id'];
    $bodyParams = [
       'query' => ['photo_id','date','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.stats.getPhotoStats';
