...
$app->post('/api/Flickr/addComment', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessSecret','photosetId','commentText']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','accessToken'=>'oauth_token','accessSecret'=>'oauth_secret','photosetId'=>'photoset_id','commentText'=>'comment_text'];
    $optionalParams = [];
    $bodyParams = [
       'query' => ['photoset_id','comment_text','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.photosets.comments.addComment';
