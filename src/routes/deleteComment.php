...
$app->post('/api/Flickr/deleteComment', function ($request, $response) {
    ...
    $optionalParams = [];
    $bodyParams = [
       'query' => ['comment_id','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.photosets.comments.deleteComment';
