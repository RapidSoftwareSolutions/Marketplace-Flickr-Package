...
$app->post('/api/Flickr/getListUserPopular', function ($request, $response) {
    ...
    $optionalParams = ['photoId'=>'user_id','count'=>'count'];
    $bodyParams = [
       'query' => ['count','user_id','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.tags.getListUserPopular';
