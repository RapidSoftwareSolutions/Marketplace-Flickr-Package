...
$app->post('/api/Flickr/getTopPlacesList', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','accessToken','accessSecret','date','placeTypeId']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','accessToken'=>'oauth_token','accessSecret'=>'oauth_secret','date'=>'date','placeTypeId'=>'place_type_id'];
    $optionalParams = ['woeId'=>'woe_id','placeId'=>'place_id'];
    $bodyParams = [
       'query' => ['place_type_id','date','place_id','woe_id','method','format','api_key','oauth_token','oauth_secret','api_secret','nojsoncallback']
    ];
    ...
    $data['method'] = 'flickr.places.getShapeHistory';
